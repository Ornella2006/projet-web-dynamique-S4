...
il peut toujours voir l'etat ou la fiche de l'adherent mais on ne voit pas les regles dans l'accepation ou recu de servation mais c'est le bibliothecaire qui dit s'il accepte ou s'il le revise


reservation et pret en retard => ne sont pas liés
s'il y'a une reservation et que tu n'a pas rendu un livre => n'est pas transformé en pret 
